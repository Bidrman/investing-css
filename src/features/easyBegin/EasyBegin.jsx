...
const EasyBegin = () => {
    return (
        <>
            <Row>
                <Col>
                    <h2 className={'font-weight-lighter text-center mb-5'}>Už od sto korun</h2>
                </Col>
            </Row>
            <Row>
                <Col xs='12' sm='6'>
                    <Card className={'border-0 mr-3'}>
                        <div className={'card-title'}>
                            <h4 className={'font-22 text-black'}>Stačí pár set korun</h4>
                        </div>
                ...
                <Col xs='12' sm='6'>
                    <Card className={'border-0 mr-3'}>
                        <div className={'card-title'}>
                            <h4 className={'font-22 text-black'}>Vstupní poplatky</h4>
                        </div>
                        <div className={'card-text py-4'}>
